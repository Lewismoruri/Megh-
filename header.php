...
<head>
	...
	if($cur_page == 'index.php' || $cur_page == 'customer/index.php' || $cur_page == 'customer/index.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php') {
		?>
	...
	{
		$statement = $pdo->prepare("SELECT * FROM product WHERE productID=?");
		$statement->execute(array($_REQUEST['id']));
		$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
		foreach ($result as $row) 
		{
			$og_photo = $row['product_image'];
		    $og_title = $row['product_cat'];
...
<div class="header" style="background-color: " >
	<div class="container">
		<div class="row inner">
			...
			<h4><button class="btn btn-danger"><a href="index.php" class="active"><font color="white">Back</font></a></button></h4>
			<hr>
			</div>
