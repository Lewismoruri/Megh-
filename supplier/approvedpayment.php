    ...
    <div class="mother-grid">
        <div class="container">
            <div class="temp-padd">
                ...
                <h4 class="heading-4 text-center mb-2 text-white bg-primary"> Record(s)</h4>
                <?php
                require 'dbh.inc.php';

                $Orgid = $_SESSION['EMAIL'];
                $sql =  "SELECT * FROM requests WHERE  supplier = '".$_SESSION['EMAIL']."'and payStatus='Paid and Received' or payStatus='Received' ORDER BY date_created desc";
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($query) > 0) {
                                ...
                                if($row['payStatus']=='Paid'){
                                    ?>
                                   <a href="acceptpayment.php?id=<?php echo $row['id']; ?>&task=Received"  class="btn btn-success btn-sm" style="width:100%;margin-bottom:4px;">Received</a>
