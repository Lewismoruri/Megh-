...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">SUPPLIED REQUEST</font></h4>
...
<?php                                      $sql = "SELECT * FROM requests WHERE  supplier = '".$_SESSION['EMAIL']."'and status='Confirmed' or status='Approved' or status='Received and Update' or status='Received' or status='Supplied' ORDER BY date_created desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php if($result->status=='Confirmed')
                                            {
                                                ?>
