...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">PENDING PAYMENT</font></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="green">Amount Paid</font></th>
                                            <th><font color="green">Transaction Id</font></th>  
                                            <th><font color="green">Payment Method</font></th>  
...
<?php                                      $sql = "SELECT * FROM requests WHERE payStatus='Paid' and supplier = '".$_SESSION['EMAIL']."' ORDER BY date_created desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->paymethod);?></td>  
                                            <td class="center"><?php echo htmlentities($result->date_created);?></td>    
                                            <td class="center"><?php echo htmlentities($result->payStatus);?></td>                                                                                                                                       
                                            <td class="center"><?php if($result->payStatus=='Paid')
                                            {
                                                ?>
                                                 <a href="acceptpayment.php?id=<?php echo $result->id; ?>&task=Paid and Received" class="btn btn-success btn-sm" style="width:100%;margin-bottom:4px;">Received</a>
                                   <!-- <a href="declinepay.php?id=<?php echo $result->id; ?>" class="btn btn-danger btn-sm" style="width:100%;margin-bottom:4px;">Reject</a>-->
