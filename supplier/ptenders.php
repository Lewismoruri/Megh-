...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">SUPPLY REQUEST</font></h4>
...
<?php                                      $sql = "SELECT * FROM requests WHERE status= 'Active' and supplier = '".$_SESSION['EMAIL']."' ORDER BY date_created desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php if($result->status=='Active')
                                            {
                                                ?>
                                                <a href="acceptorder.php?id=<?php echo $result->id; ?>" class="btn btn-success btn-sm" style="width:100%;margin-bottom:4px;">Accept</a>
