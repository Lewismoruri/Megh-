            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                            ...
                            <?php
                                if($row['order_status']=='Pending'){
                                    ?>
                                    <a href="order-change-status.php?id=<?php echo $row['id']; ?>&task=Approved" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Approve</a>
                                    <?php
                                }
                            ?>
                        </td>
                        ...
                        <td>
                           <b> Remark :</b><?php echo $row['cust_remark']; ?>
									...
									<div class="modal-content">
										...
										<div class="modal-body" style="font-size: 14px">
											<form action="" method="post">
                                                ...
                                                <input type="hidden" name="sender" value="inventory">
													<tr>
														<td>Sender</td>
														<td>
                                                            <input type="text" name="subject_text" value="inventory" readonly class="form-control" style="width: 100%;">
														</td>
													</tr>
                                                    <tr>
                                                        <td>Message</td>
