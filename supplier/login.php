...
?>
    ...
    <div class="container" ><!-- container Starts -->
        ...
        <center> <h2 class="form-login-heading" ><font color="black">Supplier Login</h2></center>
<div>
...
if(isset($_POST['admin_login'])){
    ...
    $get_admin = "select * from tbluseraccount where EMAIL='$EMAIL' AND U_PASS='$U_PASS' AND U_ROLE='Supplier' AND STATUS='1'";
