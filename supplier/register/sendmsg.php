        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <input type="hidden" class="form-control" id="user_id" name="user_id" readonly value="<?php echo $r1['EMAIL']; ?>">
                <input type="hidden" class="form-control" id="user_id" name="user" readonly value="">
...
<div class="font-italic">Staff<span style="color:red">*</span></div>
                              ...
                              <?php
                              $q1 = mysqli_query($conn, 'SELECT * FROM tbluseraccount WHERE U_ROLE = "finance" OR U_ROLE = "Inventory"');
