...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">COMPLETED PAYMENT</font></h4>
...
<?php                                      $sql = "SELECT * FROM requests WHERE  supplier = '".$_SESSION['EMAIL']."'and payStatus='Paid and Received' or payStatus='Received' ORDER BY date_created desc";
$query = $dbh -> prepare($sql);
$query->execute();
