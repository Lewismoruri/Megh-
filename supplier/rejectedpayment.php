...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="white">REJECTED PAYMENT</font></h4>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="green">Rejection Reason</font></th> 
                                        </tr>
                                    </thead>
                                    <tbody

<?php                                      $sql = "SELECT * FROM requests WHERE  supplier = '".$_SESSION['EMAIL']."'and  payStatus='Rejected' ORDER BY date_created desc";
$query = $dbh -> prepare($sql);
$query->execute();
