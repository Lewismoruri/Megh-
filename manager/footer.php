	...
	<script src="inc/js/jss/bootstrap.min.js"></script>
	...
	<script src="inc/js/on-off-switch.js"></script>
    <script src="inc/js/on-off-switch-onload.js"></script>
    <script src="inc/js/clipboard.min.js"></script>
	<script src="inc/js/demo.js"></script>
	<script src="inc/js/summernote.js"></script>
