...
$sql="INSERT INTO  store(varietyName,qty,description) VALUES(:varietyName,:qty,:description)";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h3 class="title"><font color="purple">ADD NEW TOOL</font></h3>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                    <button class="btn btn-sm btn-info"><a href="store.php"><font color="white">Back</font></a></button>
                                        <li class="active"></li>
                                    </ul>
                                </div>
...
<div class="col-sm-10">
<input type="text" name="varietyName" class="form-control" id="varietyName" required="required" autocomplete="off">
</div>
</div>

<div class="form-group">
<label for="shootdate" class="col-sm-2 control-label">Quantity</label>
<div class="col-sm-10">
