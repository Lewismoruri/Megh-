        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="user-content">
                    <center><h3><font color="black">AVAILABLE TOOLS</font></h3></center>
<a href="../index.php"><button class="btn btn-danger btn-round">Back</button></a><br><br>
<a href="add_service.php"><button class="btn btn-success btn-round">Add New</button></a><br><br>
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                <th><?php echo '#' ?></th>
                                   <!-- <th ><font color="black">Order Num</font></th>-->
                                    <th><font color="black">Tool Name</font></th></th>
            ...
            $statement = $pdo->prepare("SELECT * FROM store ");
            $statement->execute();
            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                       <?php echo $row['qty']; ?> Pcs<br>
                                        </td>
                                        <td>
                                       <?php echo $row['description']; ?> Pcs<br>
                                        </td>
                                        <td>                                          
                                        <?php echo $row['status']; ?>
                                        </td>
