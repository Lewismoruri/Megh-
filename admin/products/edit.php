       ...
       <form class="form-horizontal span6" action="controller.php?action=edit" method="POST"  />
        ...
        <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "OWNERNAME">Model Number :</label>

                      <div class="col-md-8">
                            <input class="form-control input-sm" id="" name="MODELNUM" placeholder=
                            "Model Number" type="text" value="<?php echo $singleproduct->MODELNUM; ?>">
                      </div>
                    </div>
                  </div>  
                  <div class="form-group">
