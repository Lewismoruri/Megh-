         ...
         <div class="col-lg-12">
          ...
          <!-- /.col-lg-12 -->
              ...
              <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "OWNERNAME">Serial Number:</label>

                      <div class="col-md-8">
                            <input class="form-control input-sm" id="MODELNUM" name="MODELNUM" placeholder=
                            "Model Number" type="text" value="">
                      </div>
                    </div>
                  </div>  
                  <div class="form-group">
