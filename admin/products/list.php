<?php
		...
		<div class="row" style="background-color:">
       	 <div class="col-lg-12">
            <h4 class="page-header"><font color="black">List of Products</font>  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h4>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
			  ...
			  <tbody>
				    ...
				    echo '<td style="padding:0px;">
				  		...
				  		echo '<td><b>Name :</b><a title="edit" href="'.web_root.'admin/products/index.php?view=edit&id='.$result->PROID.'">'.$result->OWNERNAME.'</a><br>

						</td>';
				  		
				  		echo '<td>'. $result->PRODESC.'<br><br>
						  <b>Model Number:</b>'. $result->MODELNUM.'
						</td>'; 
						...
						echo '<td><a title="edit" href="'.web_root.'admin/products/index.php?view=edit&id='.$result->PROID.'"><i class="fa fa-pencil "></i> Edit</a></td>';
