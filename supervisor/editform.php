        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-info" href="approvedbookings.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>                                    
                                    ...
                                    <input class="form-control" readonly name="photographer_status" type="hidden" value='On Process' required>
...
<select name="photographer" onchange="showLoanDetails(this.value)" class="form-control" required>
<option value="">Select</option>
<?php
$q1=mysqli_query($conn,"SELECT * from tbluseraccount  where U_ROLE='Technician' and  STATUS='1' ");
