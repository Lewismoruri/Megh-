...
?>
    ...
    <div class="container" ><!-- container Starts -->
        ...
        <center> <h2 class="form-login-heading" ><font color="black">Supervisor Login</h2></center>
<div>
...
<label>Enter Your Password</label>
    ...
    <div class="container"  >
    <a href="../index.php" ><font color="black"><button class="btn btn-sm btn-danger ">Back</button></font></a><br>
</div>
...
if(isset($_POST['admin_login'])){
    ...
    $get_admin = "select * from tbluseraccount where EMAIL='$EMAIL' AND U_PASS='$U_PASS' AND U_ROLE='supervisor' AND STATUS='1'";
