    ...
    <div class="mother-grid">
        <div class="container">
            <div class="temp-padd">
                ...
                $sql =  "SELECT * FROM requests WHERE  supplier = '".$_SESSION['EMAIL']."'and status='Rejected' ORDER BY date_created desc";
