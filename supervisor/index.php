...
$get_pendingpayment = "SELECT * FROM tbl_bookings where status='Approved' and photographer_status='Completed' and sup_remark=''";
$run_pendingpayment = mysqli_query($con,$get_pendingpayment);
$count_pendingpayment = mysqli_num_rows($run_pendingpayment);

$get_approvedpayment = "select * from tbl_bookings where status='Approved' and sup_remark!=''";
