...
<a class="navbar-brand" href="index.php?dashboard" ><font color="white"><h4>Supervisor Panel</h4></font></a>
...
<li>
 ...
 <li>
            <a href="managebookings.php" style="color:white">Pending Task </a>
        </li>
        <li>
            <a href="approvedbookings.php" style="color:white"> Completed Task </a>
        </li>
        <li>
