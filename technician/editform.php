        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-info" href="pending.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>                                    
                                    ...
                                    <input class="form-control" readonly name="photographer_status" type="hidden" value='Completed' required>
                                            <input class="form-control" readonly name="id" type="hidden" value='<?php echo $row['id']; ?>' required>
                                       
                                        

<div class="form-group">
<div class="font-italic">Remark<span style="color:red">*</span></div>
<textarea class="form-control" cols="25" rows="6"  name="recommandation"  required></textarea>
</div>
