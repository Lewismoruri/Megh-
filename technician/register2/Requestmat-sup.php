...
$id=$_GET['id'];
$status=Approved;
$sql = "update requestmateriallist set status=:status  WHERE id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query -> execute();
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h3 > <font color="black">SUPERVISOR REQUEST:</font></h3></center>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="black">Requested Quantity (kgs)</font></th>
...
<?php if($result->status==Pending)
 {?>
<a href="Requestmat-sup.php?id=<?php echo htmlentities($result->id);?>"  >  <button class="btn btn-success btn-sm"> Confirm</button>
<?php } else {?> <?php } ?>

<?php if($result->status==Approved)
 {?>
	<a href="update_req.php?varietyName=<?php echo $result->varietyName; ?>&task=Released and Update" class="btn btn-danger btn-xs" style="width:100%;margin-bottom:4px;">Release</a>
<?php } else {?> <?php } ?>
