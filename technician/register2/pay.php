...
?>                                    
                                    <form role="form" action="payref.php" method="post">
                                     
                                        
                                            <input class="form-control" readonly name="id" type="hidden" value='<?php echo $row['id']; ?>' required>
                                           
                                     <div class="form-group">
<div class="font-italic">Enter Ref Number<span style="color:red">*</span></div>
<input type="text" name="Ref" minlength="10" maxlength="10" required></textarea>
</div>
