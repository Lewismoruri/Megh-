        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-info" href="myrequest.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div class="font-italic">Accept or Reject Goods<span style="color:red">*</span></div>
<select name="rate">
    ...
    <option value="rejected">Reject</option>
                                     ...
                                     <div class="form-group">
<div class="font-italic">Type Your Comment Here<span style="color:red">*</span></div>
<textarea cols="25" rows="5" class="form-control" name="custremark" required></textarea>
</div>
