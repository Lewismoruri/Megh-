...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">PAYMENT SECTION</h3>
...
$id=$_GET['id'];
$qry= "SELECT * FROM requestsmat where id='$id'
"; 
...
?>                                    
                                    <form role="form" action="payprocess.php" method="post">
                                            ...
                                            <input class="form-control" readonly name="payStatus" type="hidden" value='Paid' required>   
                                            <div class="form-group">
<div class="font-italic">Enter M-Pesa Code Here <span style="color:red">*</span></div>
<input class="form-group" type="text" minlength="10" maxlength="10" name="ref" required></textarea>
</div>
