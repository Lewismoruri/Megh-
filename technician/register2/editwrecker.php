...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">MANAGE SPECIAL REQUEST</h3>
                    <a class="btn btn-info" href="managerequest.php">Back</a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>                                    
                                    <form role="form" action="editw.php" method="post">
                                     
                                        
                                            <input class="form-control" readonly name="id" type="hidden" value='<?php echo $row['id']; ?>' required>
                                           
                                            <div class="form-group">
<div class="font-italic">Set Status<span style="color:red">*</span></div>
<select name="status" reuired>
    ...
    <option value="Rejected">Reject </option>
                                            ...
                                            <div class="form-group">
<div class="font-italic">Set Price<span style="color:red">*</span></div>
<input type="number" name="charges" required></textarea>
</div>

<div class="form-group">
<div class="font-italic">Write A Remark<span style="color:red">*</span></div>
<textarea cols="26" rows="5" name="remark" required></textarea>
</div>
