...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">ADD REMARK </h3>
...
?>                                    
                                    <form role="form" action="setremark.php" method="post">
...
<div class="font-italic">Add Your Remarks Here <span style="color:red">*</span></div>
<textarea type="text" class="form-control" cols="25" rows="6" name="remark" required></textarea>
</div>
