...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h3 > <font color="black">SCRAP MATERIAL SUPPLIES:</font></h3></center>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="black">Suppplier Name</font></th>
                                            <th><font color="black">Supplied Quantity</font></th>
                                            <th><font color="black">Description</font></th>
                                            <th><font color="black">Price (ksh)</font></th>
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from requestsmat ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->firstname);?> <?php echo htmlentities($result->lastname);?></td>    
...
<?php if($result->status==Pending)
 {?>
<a href="supplies.php?id=<?php echo htmlentities($result->id);?>"  >  <button class="btn btn-success btn-sm"> Received</button>
<?php } else {?> <?php } ?>
...
<?php if($result->status==Received)
 {?>
	<a href="update.php?varietyName=<?php echo $result->varietyName; ?>&task=Received and Updated" class="btn btn-danger btn-md" >Update</a>
<?php } else {?> <?php } ?>
 ...
 <?php $cnt=$cnt+1;}} ?>                                      
                            ...
                            <button class="btn btn-warning"><a href="../admin_panel.php"> <font color="black"><i class="fa fa-arrow-left"></i>&nbsp;Back</font></a></button>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
