...
$query -> execute();
header('location:chocopending.php');
}
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h3 > <font color="black">My Pending Task :</font></h3>
...
<?php } else {?> <?php } ?>
                                            ...
                                            <td class="center">
                                            <?php if($result->inventoryStatus==Pending)
 {?>
<a href="chocopending.php?id=<?php echo htmlentities($result->id);?>"  >  <button class="btn btn-primary btn-sm"> Done</button>
<?php } else {?> <?php } ?>
 ...
 <?php $cnt=$cnt+1;}} ?>                                      
                            ...
                            <button class="btn btn-sm btn-primary"><a href="../chocolatier_panel.php"><font color="white">Back</font></a></button>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
