...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">PENDING SCRAP MATERIAL SUPPLIES :</font></h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th><font color="green">Material Name</font></th>
                                            <th><font color="green">Supplied Quantity</font></th>
...
<?php                                      $sql = "SELECT *FROM requestsmat where status='Pending'  ";
$query = $dbh -> prepare($sql);
$query->execute();
