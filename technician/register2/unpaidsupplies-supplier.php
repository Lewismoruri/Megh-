...
{
$id=$_GET['inid'];
$payStatus='Paid and Received';
$sql = "update requestsmat set payStatus=:payStatus  WHERE id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query -> bindParam(':payStatus',$payStatus, PDO::PARAM_STR);
$query -> execute();
header('location:unpaidsupplies-supplier.php');
}
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">Pending Payments :</font></h4>
            ...
            <div class="row">
                ...
                <a href="../supplier_panel.php"><font color="white"><button class="btn btn-sm btn-primary">Back</button></font></a></button>
</div>
...
<?php                                      $sql = "SELECT *FROM requestsmat where (payStatus='Not Yet Paid' or payStatus='Paid') and Ref!=''  ";
$query = $dbh -> prepare($sql);
$query->execute();
