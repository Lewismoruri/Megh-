...
$query -> execute();
header('location:mypendingtask.php');
}
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h3 > <font color="black">PENDING SPECIAL REQUEST :</font></h3>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="red">LOCATION DETAILS</font></th>
                                            <th><font color="red">ORDER STATUS</font></th>
                                            <th><font color="red">DRIVER ASSIGNED</font></th>
                                            <th><font color="red">Action</font></th>
                                        </tr>
                                    </thead>
                                    <tbody

<?php                                      $sql = "SELECT *FROM requests where inventoryStatus='Completed'  ";
$query = $dbh -> prepare($sql);
$query->execute();
...
<?php } else {?> <?php } ?>
                                            ...
                                            <td class="center">
                                            <?php 
                                            if($result->inventoryStatus='Goods On Transit')
 {?>
<a href="mypendingtask.php?id=<?php echo htmlentities($result->id);?>"  >  <button class="btn btn-primary btn-sm">Mark Delivered</button>
<?php } else {?> <?php } ?>
 ...
 <?php $cnt=$cnt+1;}} ?>                                      
                            ...
                            <button class="btn btn-sm btn-primary"><a href="../driver_panel.php"><font color="white">Back</font></a></button>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
