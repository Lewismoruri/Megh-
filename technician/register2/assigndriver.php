...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <center><h3 class="page-header">ALLOCATE DRIVER</h3></center>
                    <a class="btn btn-info" href="allocatedriver.php">Back</a><br><br>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>                                    
                                    <form role="form" action="alldr.php" method="post">
                    ...
                    <div class="col-xl-6">
                        <label class="form-control-label">Select Driver<span class="text-danger ml-2">*</span></label>
                         <?php
                        $qry= "SELECT * FROM staff where role='driver'";
                        $result = $conn->query($qry);
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="driver" onchange="classArmDropdown(this.value)" >';
