...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">Unpaid Supplies :</font></h4>
            ...
            <div class="row">
                <div class="col-md-12">
                   ...
                   <a href="../finance_panel.php"> <button class="btn btn-sm btn-primary"><font color="white">Back</font></button></a>
                       </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><font color="green">Supplier Name</font></th>
                                            <th><font color="green">Quantity</font></th>
                                            <th><font color="green">Price Per (Kg)</font></th>
                                            <th><font color="red">AMOUNT TO BE PAID</font></th>
                                            <th><font color="green">Supplied On</font></th>
...
<?php                                      $sql = "SELECT *FROM requestsmat where (status='Received' or status='Received and Updated') and ref=''  ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                       ...
                       ?>
                              ...
                              <?php if($result->Ref=='')
 {?>
<a href="paynow.php?id=<?php echo htmlentities($result->id);?>&task=Supplied"  >  <button class="btn btn-warning btn-sm"> Pay</button>
<?php } else {?>
