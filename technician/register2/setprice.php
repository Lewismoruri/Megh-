...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">SET PRICE</h3><br>
                    <a class="btn btn-info" href="managerequest.php"><button>Back</button></a>
                </div><br>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>                                    
                                    <form role="form" action="setpprocess.php" method="post">
...
<div class="font-italic">Set Price Per Kg <span style="color:red">*</span></div>
