...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">Paid Supplies :</font></h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th><font color="green">Scrap Type</font></th>
                                            <th><font color="green">Supplier Name</font></th>
                                            <th><font color="green">Quantity</font></th>
                                            <th><font color="green">Price Per (Kg)</font></th>
                                            <th><font color="red">AMOUNT PAID</font></th>
                                            <th><font color="red">M-Pesa Transaction Code</font></th>
                                            <th><font color="green">Supplied DateS</font></th>
                                            <th><font color="green">Payment Status</font></th>
                                        </tr>
                                    </thead>
                                    <tbody

<?php                                      $sql = "SELECT *FROM requestsmat where (status='Received' or status='Received and Update') and ref!=''  ";
$query = $dbh -> prepare($sql);
$query->execute();
