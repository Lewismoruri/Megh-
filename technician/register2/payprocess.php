        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12"><br>
                  <center>  <h4 class="page-header"><a href="unpaidsupplies.php"><button>Back</button></a></h4></center>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
if (!preg_match($naming,$ref)) {
    ...
    header("Refresh:0.05; url=bookin_pay_error.php");
				...
				//update query
				$qry = "update requestsmat set id='$id',ref='$ref',payStatus='$payStatus' where id='$id'";
