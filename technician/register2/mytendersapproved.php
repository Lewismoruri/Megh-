...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 > <font color="black">APPROVED SUPPLIED SCRAP MATERIALS :</font></h4>
            ...
            <div class="row">
                ...
                <a href="../supplier_panel.php"><font color="white"><button class="btn btn-sm btn-primary">Back</button></font></a>
</div>
...
<?php                                      $sql = "SELECT *FROM requestsmat where status='Approved' or status='Confirmed' or status='Received' ";
$query = $dbh -> prepare($sql);
$query->execute();
