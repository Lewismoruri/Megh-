...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
               <center> <h3 > <font color="black">Scrap Materials In Stock:</font></h3></center>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th><font color="black">Type</font></th>
...
<?php if($result->status==Approved)
 {?>
<a href="supplies.php?id=<?php echo htmlentities($result->id);?>"  >  <button class="btn btn-success btn-sm"> Confirm</button>
<?php } else {?> <?php } ?>
