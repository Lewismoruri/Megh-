...
$get_pendingpayment = "select * FROM tbl_bookings WHERE  photographer_status='On Process' and photographer='".$_SESSION['EMAIL']."'";
$run_pendingpayment = mysqli_query($con,$get_pendingpayment);
$count_pendingpayment = mysqli_num_rows($run_pendingpayment);

$get_approvedpayment = "select * FROM tbl_bookings WHERE  photographer_status='Completed' and photographer='".$_SESSION['EMAIL']."'";
$run_approvedpayment = mysqli_query($con,$get_approvedpayment);
$count_approvedpayment = mysqli_num_rows($run_approvedpayment);

$get_rejectedpayment = "select * from requests_material where inventoryStatus='Rejected'";
