...
$sql="INSERT INTO  tbl_bookings(stu_id,full_name,email,phone,service,charges,fee) VALUES(:stu_id,:full_name,:email,:phone,:service,:charges,:fee)";
              ...
              <div class="col-lg-8 mb-4">
                ...
                <input type="hidden" class="form-control" id="stu_id" name="stu_id" readonly value="<?php echo $user['cust_id']; ?>">
                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls">
                            <label>Charges:</label>
                            <input type="tel" class="form-control" id="phone" name="charges" readonly value="<?php echo $user['cust_phone']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="fee" onchange="classArmDropdown(this.value)" class="form-control mb-3">';
