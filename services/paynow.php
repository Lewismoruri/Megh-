...
?>                                    
                                    <form role="form" action="payprocess.php" method="post"><hr>
    ...
    <option >M-Pesa: <br>Till Number : 8758758<br> </option>
    <option >Equity Bank: <br>   Account No: 234988584</option>
    <option >Kenya Commercial Bank: <br>   Account No: 53465533</option>
    <option>Family Bank: <br>   Account No: 867435353</option>
    <option>Cooperative Bank: <br>   Account No: 53242455</option>
</select>
                            </label>
                        </div>
                                        <hr>
                                        <div class="form-group">
                                            ...
                                            <select name="method" id="paymentmethod" onchange="updateTransactionCodeInput()">
    ...
    <option value="Cooperative Bank">Cooperative Bank</option>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" readonly  name="total" value="<?php echo ($row['charges']*$row['qty'])+$row['fee'];?>"  required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Transaction Code</label>
                                            <input class="form-control" type="text"  id="Ref" name="transactioncode"  required>
                                        </div>
