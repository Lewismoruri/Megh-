...
if(strlen($_SESSION['CUSID']['CUSTOMERID'])==0)
    {   
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <center><h4 > <font color="black"><b>OUR SERVICES</b></font></h4></center>
   ...
   <!-- <div class="container">
    <center><button class="btn  btn-primary"><a href="book.php"><font color="white"><i class="fa fa-book"></i>&nbsp;Book Now</font></a></button></center>
            ...
            <div class="row">
                <div class="col-md-12">
               <a href="../index.php"> <button class="btn btn-sm btn-danger"><font color="white">Back</font></button></a><br><br>
                    <!-- Advanced Tables -->
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                            <a href="booknow.php?serviceid=<?php echo htmlentities($result->serviceid);?>" class="btn btn-primary btn-md">Request Now</a>
                                        </td>  
                                           </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
