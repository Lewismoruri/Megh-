...
?>
    ...
    <div class="container" ><!-- container Starts -->
        ...
        <center> <h2 class="form-login-heading" ><font color="black">Driver Login</h2></center>
<div>
...
if(isset($_POST['admin_login'])){
    ...
    $get_admin = "select * from tbluseraccount where EMAIL='$EMAIL' AND U_PASS='$U_PASS' AND U_ROLE='Driver' AND STATUS='1'";
