...
$get_mytask = "select * from tblsummary where SHIPPING_STATUS='Goods on Transit' and DRIVER='".$_SESSION['EMAIL']."'";
$run_mytask = mysqli_query($con,$get_mytask);
$count_mytask = mysqli_num_rows($run_mytask);

$get_completedtask = "select * from tblsummary where SHIPPING_STATUS='Goods Delivered' and DRIVER='".$_SESSION['EMAIL']."'";
$run_completedtask = mysqli_query($con,$get_completedtask);
$count_completedtask = mysqli_num_rows($run_completedtask);
