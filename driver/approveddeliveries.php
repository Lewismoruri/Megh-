...
<section class="content-header">
	<div class="content-header-left">
		<center><h4>DRIVER ALLOCATIONS</h4></center>
	</div>
</section>
<div class="container">
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tblsummary where SHIPPING_STATUS='Approved' AND DRIVER!='Not Assigned' ORDER by SUMMARYID DESC");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr>
                        ...
                        <td>
                            <?php
                                if($row['SHIPPING_STATUS']=='Approved'){
                                    ?>
                                    <a href="editform.php?SUMMARYID=<?php echo $row['SUMMARYID']; ?>" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Re-Assign Driver</a>
