                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody
                                    <?php
$sql = "SELECT DISTINCT requests_material.*, tblcategory.CATEGORIES, tblproduct.PROQTY, tblproduct.weight  FROM requests_material INNER JOIN tblcategory ON tblcategory.CATEGID = requests_material.CATEGID INNER JOIN tblproduct ON tblproduct.CATEGID = requests_material.CATEGID";
$query = $dbh->prepare($sql);
$query->execute();
