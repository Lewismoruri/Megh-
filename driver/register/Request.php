...
<body>
  ...
  <select name="varietyName">
    ...
    <option value="PAN67">PAN 67</option>
    <option value="PAN53">PAN 53</option>
    <option value="Longe7">Longe 7</option>
    <option value="Longe5">Longe 5</option>
    <option value="Hibrido8">Hibrido 8</option>
  </select>
                            </div>
                        </div>
                        <div class="control-group form-group">
