...
$grade = mysqli_real_escape_string($conn,$_POST['grade']);
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   ...
   echo '<script type="text/javascript">window.location="pendingcustomer.php?act=2";</script>';
 }
...
$conn->query("UPDATE  tblcustomer set STATUS = '1'  WHERE CUSTOMERID='".$_GET['CUSTOMERID']."'");	
header("location: pendingcustomer.php?act=3");
...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Customer has been Activated!</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pending Customers  
                        ...
                        <div class="panel-body">
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr '.(($r['STATUS']=2)?'class="primary"':'').'>
                                            <td>'.$i.'</td>
											...
											<a onclick="return confirm(\'Are you sure you want to Activate this record\');" href="pendingcustomer.php?action=delete&CUSTOMERID='.$r['CUSTOMERID'].'" class="btn btn-success btn-xs" style="border-radius:60px;">Approve&nbsp;<span class="glyphicon glyphicon-edit"></span></a> </td>
