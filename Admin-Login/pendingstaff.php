...
$grade = mysqli_real_escape_string($conn,$_POST['grade']);
 ...
 $balance = $fees-$advancefees;
  ...
  $q1 = $conn->query("INSERT INTO tbluseraccount (sname,joindate,contact,about,emailid,grade,balance,fees) VALUES ('$sname','$joindate','$contact','$about','$emailid','$grade','$balance','$fees')") ;
  
  $sid = $conn->insert_id;
  
 $conn->query("INSERT INTO  fees_transaction (stdid,paid,submitdate,transcation_remark) VALUES ('$sid','$advancefees','$joindate','$remark')") ;
    
   echo '<script type="text/javascript">window.location="pendingcustomer.php?act=1";</script>';
 
 }else
  if($_POST['action']=="update")
 {
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  tbluseraccount  SET  grade  = '$grade', sname = '$sname', contact = '$contact', about = '$about', emailid = '$emailid'  WHERE  id  = '$id'");
   echo '<script type="text/javascript">window.location="pendingstaff.php?act=2";</script>';
 }
...
header("location: pendingstaff.php?act=3");
...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Staff has been Activated!</div>";
}
...
<head>
    ...
    <title>CHLORIDE EXIDE KENYA LTD</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pending Staffs  
                        ...
                        <div class="panel-body">
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from tbluseraccount where STATUS='0'";
									$q = $conn->query($sql);
									$i=1;
									while($r = $q->fetch_assoc())
									{
										...
										<td>
											...
											<a onclick="return confirm(\'Are you sure you want to Activate this record\');" href="pendingstaff.php?action=delete&USERID='.$r['USERID'].'" class="btn btn-success btn-xs" style="border-radius:60px;">Activate&nbsp;<span class="glyphicon glyphicon-edit"></span></a> </td>
