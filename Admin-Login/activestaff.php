...
$address = mysqli_real_escape_string($conn,$_POST['address']);
 ...
 if($_POST['action']=="add")
 {
  $q1 = $conn->query("INSERT INTO tbluseraccount (first_name,last_name,role,contact,gender,emailid,address) VALUES ('$first_name','$last_name','$role','$contact','$gender','$emailid','$address')") ;
  
  $sid = $conn->insert_id;
  header("location: activestaff.php?act=1");
...
$conn->query("UPDATE  tbluseraccount set STATUS = '2'  WHERE USERID='".$_GET['USERID']."'");	
header("location: activestaff.php?act=3");
...
{
$errormsg = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>New Staff record has been added!</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Staff record has been updated!</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Staff has been deactivated!</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Active Staff  
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="activestaff.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">Go Back </a>':'<a href="activestaff.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> Add New Staff</a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Add Staff Details": "Edit Staff Details"; ?>
                        </div>
						<form action="activestaff.php" method="post" id="signupForm1" class="form-horizontal">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Role* </label>
								<div class="col-sm-10">
                        ...
                        <div class="panel-body">
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from tbluseraccount where STATUS='1'";
									$q = $conn->query($sql);
									$i=1;
									...
									echo '<tr >
											...
											<a onclick="return confirm(\'Are you sure you want to deactivate this record\');" href="activestaff.php?action=delete&USERID='.$r['USERID'].'" class="btn btn-danger btn-xs" style="border-radius:60px;">Deactivate <span class="glyphicon glyphicon-remove"></span></a> </td>
