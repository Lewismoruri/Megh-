...
<section class="content-header">
	<div class="content-header-left">
		<center><h4>SHIPMENT REPORT</h4></center>
	</div>
</section>
<div class="container">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                        <b>County :</b><?php echo $row['ORDEREDDATE']; ?><br>
                        <b>Location :</b><?php echo $row['LOCATIONDETAILS']; ?><br>
                        </td>
                        <td>
                        <b><font color="">Order Num :<?php echo $row['ORDEREDNUM']; ?></font><br>
                       ...
                       <b> Total Price :</b><?php echo $row['PAYMENT']-$row['DELFEE']; ?><br>
                        ...
                        <b><font color="">TOTAL :Ksh </b><?php echo $row['PAYMENT']; ?></font><br><br>
                            <br>
                           <!-- <?php
