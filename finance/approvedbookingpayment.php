...
<section class="content-header">
	<div class="content-header-left">
		<center><h3>Approved Booking  Payment</h3></center>
	</div>
</section>
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                ...
                                echo '<br><b>Charges Per Item:</b> ' . ($row1['pricing']);
                                echo '<br><b>Number of Item:</b> ' . ($row['qty']);
                                echo '<br><b>Commutation Fee:</b> ' . ($row['fee']);
                                echo '<br><br>';
                           }
                           ?>
                        </td>
                        <td>
                            ...
                            <b>Paid Via: </b><?php echo $row['method']; ?><br>
                        </td>
                        <td>
