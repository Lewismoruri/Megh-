...
?>
    ...
    <div class="container"  ><!-- container Starts -->
        ...
        <form class="form-group" action="" method="post" ><!-- form-login Starts -->
           <center> <h2 class="form-login-heading" ><font color="black">Finance Login</h2></center>
<div>
...
if(isset($_POST['admin_login'])){
    ...
    $get_admin = "select * from tbluseraccount where EMAIL='$EMAIL' AND U_PASS='$U_PASS' AND U_ROLE='finance' AND STATUS='1'";
