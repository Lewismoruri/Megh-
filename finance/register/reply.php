        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <input type="hidden" class="form-control" id="user_id" name="recepient" readonly value="<?php echo $r2['recepient']; ?>">
                <input type="hidden" class="form-control" id="user_id" name="user" readonly value="finance">
