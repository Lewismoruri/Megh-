...
<section class="content-header">
	<div class="content-header-left">
		<center><h4><font color="black">APPROVED OREDER PAYMENT</font></h4></center>
	</div>
</section>
<div class="container">
        ...
        <div class="box-body table-responsive table-bordered">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM `tblsummary` where PAYMENT_STATUS='Approved'  ");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>                   
                       <b> Total Price :</b><?php echo $row['PAYMENT']-$row['DELFEE']; ?><br>
                        <b>Delivery Fee :</b><?php echo $row['DELFEE']; ?></b><br>
                        ...
                        <b><font color="red">GRAND :</b><?php echo $row['PAYMENT']; ?></font><br><br>
