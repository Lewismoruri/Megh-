...
<section class="content-header">
	<div class="content-header-left">
		<center><h4>PAID TENDERS</h4></center>
	</div>
</section>
<div class="container">
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM requests where payStatus='Paid and Received' or payStatus='Paid' ORDER by id DESC");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr>
                        ...
                        <td>
                           <b> Maize Grains Variety Name: </b><?php echo $row['varietyName']; ?><br>
                           <b> Requestes Quantity (Kgs) : </b><?php echo $row['quantity']; ?><br>
                           <b> Charges Per Kg: </b><?php echo $row['charges']; ?>
                        </td> 
                        <td>
