...
<?php 
	...
	echo "<h5>Your order is on process. Please keep checking on your order status</h5>";
} 
?>
<hr/>
 <h4><strong>Order Information</strong></h4>
		<table id="table table-responsive" class="table table-responsive">
			<thead>
				<tr>
					<!-- <th>PRODUCT</th>? -->
					<th>PRODUCT</th>
				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> RF '. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> RF <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : RF <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : RF <?php echo $cur->DELFEE; ?></p>
		  		<p align="right">Overall Price : RF <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
