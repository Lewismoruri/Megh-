...
$q1=mysqli_query($conn,'select * from tblcustomer where CUSTOMERID="'.$_SESSION['CUSID']['CUSTOMERID'].'"');
...
if(strlen($_SESSION['EMAIL'])) {   
    ...
    $sql="INSERT INTO  tbmessages(CUSTOMERID,sender,recepient,fname,lname,message) VALUES(:CUSTOMERID,:sender,:recepient,:fname,:lname,:message)";
            ...
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <form name="sentaddress"  method="post">
                 ...
                 <input type="hidden" class="form-control" id="sender" name="fname" readonly value="<?php echo $r1['FNAME']; ?>">
                 <input type="hidden" class="form-control" id="sender" name="lname" readonly value="<?php echo $r1['LNAME']; ?>">
                 <input type="hidden" class="form-control" id="sender" name="sender" readonly value="<?php echo $r1['EMAIL']; ?>">
                     <div class="control-group form-group">
                     <label>Recipient:</label>
<div class="controls">
    <?php 
      $q1 = mysqli_query($conn, 'SELECT * FROM tbluseraccount WHERE U_ROLE != "Supplier" AND U_ROLE != "Manager"');

    ?>
    <select class="form-control" id="recepient" name="recepient">
        <?php while ($row = mysqli_fetch_assoc($q1)) { ?>
            <option value="<?php echo $row['USERID']; ?>"><?php echo $row['U_NAME'].' '.$row['U_ROLE']; ?></option>
        <?php } ?>
    </select>
</div>
