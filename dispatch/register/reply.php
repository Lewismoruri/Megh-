        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <input type="text" class="form-control" id="user_id" name="user_id" readonly value="<?php echo $r1['EMAIL']; ?>">
         
                <input type="text" class="form-control" id="user_id" name="recepient" readonly value="<?php echo $r2['user_id']; ?>">
