        ...
        <div class="row">
            <!-- Map Column -->
              <div class="col-lg-8 mb-4">
                ...
                <input type="hidden" class="form-control" id="user_id" name="user" readonly value="<?php echo $r1['U_ROLE']; ?>">
...
<div class="font-italic">Customer<span style="color:red">*</span></div>
                              ...
                              <?php
                              $q1=mysqli_query($conn,"SELECT * from tblcustomer  where  STATUS='1'  ");
                              while($r1=mysqli_fetch_assoc($q1))
                              {
                              echo "<option value='".$r1['CUSTOMERID']."'>".$r1['FNAME']." ".$r1['LNAME']."</option>";
                              }
                              ?>
                              </select>
                              </div>
