...
<div class="huge" style="color:white"> <?php echo $count_pendingshipment; ?> </div>
...
<div class="huge" style="color:black"> <?php echo $count_allocations; ?> </div>

<div style="color:black">Driver Allocation</div>
...
<div class="panel panel-primary"><!-- panel panel-green Starts -->
...
<div class="huge"> <?php echo $count_completed; ?> </div>
